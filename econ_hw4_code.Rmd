...
prob_scenario_1 <- 0.5
prob_scenario_2 <- 0.5
policy_A_expected_value<- (prob_scenario_1 * total_SCC_baseline) + (prob_scenario_2 * total_SCC_baseline_1.5)
...
#how to pass arg type? 
warming$warming_policy_b <- policy_b_warming(warming$year)
```
