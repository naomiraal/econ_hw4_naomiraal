...
ggplot(quad_damage_model, aes(warming, damages)) + geom_smooth(method = "lm", formula = y ~ x + I(x^2)) + geom_point() + 
  theme_gray() +
  labs(title = "Damage Function", x = "Warming in degrees C", y = "Damages in USD")
```
